...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    try {
      ...
      message.guild.channels.create("Infinite - Requests", {
          type: 'category',
              ...
              .then((channel2) => {
                try {
                  message.guild.channels.create(`🎵Infinite｜requests`, {
                      ...
                      topic: `To request a Track, simply Type the **SONG NAME** into the Channel or the **URL** and the Bot will play it!`,
                      parent: channel1.id,
                      permissionOverwrites: [{
                          id: message.guild.id,
                    ...
                    .then(async (channel3) => {
                      ...
                      let embed1 = new MessageEmbed()
                        ...
                        .setTitle("Infinite | Request | Guide")
